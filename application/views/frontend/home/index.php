    ...
    <div class="container">
        <div class="row justify-content-center pb-3">
            <div class="col-md-10 heading-section text-center ftco-animate">
                ...
                <p>Selamat datang di website Bimbel Smart Kids
                </p>
            </div>
        </div>
...
<section class="services-section ftco-section" id="vm-section">
    <div class="containerr">
        ...
        <hr>
        VISI:<br>
        From Zero To One Hundred (dari Nol ke Seratus)<br>
        <br><br>
        MISI:<br>
        1. Memberikan Pembelajaran dengan Unik dan mudah dipahami<br>
        2. Membentuk wadah terpadu belajar bagi pelajar<br>
        3. Membentuk generasi muda yang memiliki IQ yang cerdas dan EQ yang unggul<br>
        (Ibnu Sina)<br>
        " Tak ada penyakit yang tak bisa disembuhkan kecuali kemalasan.<br>
        Tak ada obat yang tak berguna selain kurangnya pengetahuan"<br><br>
       <br><br>
        <br><br>
        Founder<br>
        Fajar Syahrul Hidayat<br>
        Untuk info lebih lanjut, bisa menghubungi kami di:<br>
        Email: smartkids_bimbel@gmail.com<br>
    </div>
</section>
