         ...
         <div class="row border-bottom mb-4">
             ...
             <div class="col-sm-4 text-right pb-3">
                 ...
                 <?php if ($siswa['id'] != null) : ?>
                     <a class="btn btn-round btn-success" href="<?= base_url(); ?>datadiri/perbarui/<?= $siswa['id'] ?>"><i class="fa fa-plus"></i> Perbarui Data</a>
                 <?php else : ?>
                     <a class="btn btn-round btn-success" href="<?= base_url(); ?>datadiri/lengkapidata/<?= $siswa['id'] ?>"><i class="fa fa-plus"></i> Lengkapi Data</a>
                 <?php endif ?>
