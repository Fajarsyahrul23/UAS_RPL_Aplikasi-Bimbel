         ...
         <div class="login-box">
             ...
             <div class="row">
                 <div class="col-md-6 col-sm-6 col-12 login-box-info">
                     ...
                     <p class="mb-4">Adalah salah satu bimbel yang ada di jawa barat bimbel smart kids mengajar segala macam mata pelajaran yang ada di sekolah</p>
                     <p class="text-center"><a href="<?= base_url('auth') ?>" class="btn btn-light">kembali login</a></p>
                 </div>
